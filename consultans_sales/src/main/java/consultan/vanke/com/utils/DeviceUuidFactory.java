            ...
            synchronized (DeviceUuidFactory.class) {
                if (uuid == null) {
                    ...
                    if (oldId != null) {//如果存在存储的唯一标识码的UUID值，则直接读取
                         ...
                         */
                        @SuppressLint("MissingPermission") String deviceId = ((TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE)).getDeviceId();//根据不同的手机设备返回IMEI，MEID或者ESN码
                        ...
                        try {
                            if (deviceId != null) {
                                 ...
                                 * */
                                @SuppressLint("MissingPermission") String SimSerialNumber = ((TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE)).getSimSerialNumber();
